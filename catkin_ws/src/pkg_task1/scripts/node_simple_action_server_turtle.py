...
from pkg_task1.msg import msgTurtleActionGoal         # Message Class that is used for Goal messages
from pkg_task1.msg import msgTurtleActionResult       # Message Class that is used for Result messages
